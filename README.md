...
```
                ...
                +---------+----------------------------------+--^--------+------+--^-----^----------+
                          |                                  |  |        |      |  |     |
                          v                                  |  |        v      |  |     ^
                    (Insert Media)                          (Dupe)   (Search)  (Query) 	(Search)
                     (JSON/REST)                            (Lookups)    |   (Typeahead)(Results)
                          v                                  v  ^        v      v  ^     ^
                          |                                  |  |        |      |  |     |
             /  +---------v----------------------------------v--^--------v------v--^-----^----------+
            |   |         |                                  |  |        |      |  |     |-frontend-|
...
mediachain <    |  |                         Javascript/HTML Web App                              | |
 -frontend  |   |  +------v----------------------------------+--^--------v------v--^-----^--------+ |
            |   |         |                                  |  |        |      |  |     |          |
             \  +---------v----------------------------------v--^--------v------v--^-----^----------+
                          |                                  |  |        |      |  |     |
                     (Raw Media)                            (Dupe)   (Search)  (Query)  (Search)
                          |                                 (Lookups)    |   (Typeahead)(Results)
             /  +---------v---------------+                  |  |        |      |  |     |
            |   |         |   --indexer-- |                  |  |        |      |  |     |
            |   |  +------v-----------+   |                  |  |        |      |  |     |
mc_ingest.py<   |  |  Pre-ingestion   +...>..........>......>+  ^        v      v  ^     ^
            |   |  |  Dupe Check      +...<..........<......<+  |        |      |  |     |
            |   |  +------+-----------+   |                  |  |        |      |  |     |
            |   |         |               |                  |  |        |      |  |     |
             \  ----------v---------------+                  |  |        |      |  |     |
...
mediachain  |   |         |                 | --client-- |   |  |        |      |  |     |
 -client    |   |  +------v---------------------------+  |   |  |        |      |  |     |
  reader   <    |  |      Client Writer / Reader      |  |   v  ^        v      v  ^     ^
 & writer   |   |  +------+-----------------^---------+  |   |  |        |      |  |     |
            |   |         |                 |            |   |  |        |      |  |     |
             \  ----------+-----------------^------------+   |  |        |      |  |     |
                          |                 |                |  |        |      |  |     |
              ...
              / |         |                 |                |  |        |      |  |     | -indexer-|
             |  |  +------v----------+      |                |  |        |      |  |     |          |
mc_ingest.py<   |  | Media Ingestion |      ^                v  ^        v      v  ^     ^          |
             |  |  +------+----------+      |                |  |        |   (JSON/REST) |          |
              \ |         |                 |                |  |        |      |  |     |          |
                |         |             (Artefact)         (Dupe)   (Raw Media) |  |  (Media IDs)   |
              / |         |             (Linkage)          (Lookups)(/TextQuery)|  |  (Ranked)      |
             |  |         |                 |                |  |        |      |  |     |          |
             |  |         |                 |                |  |  +-----v------v--+-----+--------+ |
